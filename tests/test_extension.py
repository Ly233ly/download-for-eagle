...
class ExtensionTests(unittest.TestCase):
    ...
    def test_manifests_are_versioned_and_include_structured_site_bridges(self) -> None:
        ...
        self.assertIn('internal const string Version = "1.2.3"', setup)
        self.assertIn('AssemblyFileVersion("1.2.3.0")', setup)
        self.assertIn('AssemblyFileVersion("1.2.3.0")', launcher)
        version_resource = (ROOT / "packaging" / "download-transfer-station-version.txt").read_text(encoding="utf-8")
        self.assertIn("filevers=(1, 2, 3, 0)", version_resource)
        self.assertIn("prodvers=(1, 2, 3, 0)", version_resource)
